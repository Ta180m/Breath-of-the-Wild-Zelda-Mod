...
- Extract the files from the ZIP to `sdcafiine/00050000101C9400/` (change the 4 to a 3 if you're using the Japanese version or to a 5 for the European version)
- Run SDCafiine from the Homebrew Launcher, then immediately boot the game

### Cemu Emulator

- Extract the files from the ZIP to `graphicPacks/` in your Cemu directory
